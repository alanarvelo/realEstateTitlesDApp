...
contract Ownable {
    ...
    function transferOwnership(address to) public onlyOwner {
        // TODO add functionality to transfer control of the contract to a newOwner.        DONE
...
//  5) create a Paused & Unpaused event that emits the address that triggered the event     DONE
    ...
    function pauseContract(bool state) public onlyOwner {
        require(state != _paused, "contract is in the provided state");
        _paused = state;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "Approved address can't be token owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true     DONE
        require(msg.sender == _tokenOwner[tokenId] || isApprovedForAll(msg.sender, to) == true,
        "not owner or approved to approve the transfer of this token");
    ...
    function approved(uint256 tokenId) public view returns (address) {
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "can't set approval for all for same address");
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view returns (bool) {
        ...
        return (spender == owner || approved(tokenId) == spender || isApprovedForAll(owner, spender));
    }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "'from' address is not owner of this token");
...
//  TODO's: Create CustomERC721Token contract that inherits from the ERC721Metadata contract. You can name this contract as you please          DONE
...
//      -calls the superclass mint and setTokenURI functions
    ...
    function mint(address to, uint256 tokenId) public onlyOwner returns (bool) {                            // , string memory tokenURI
        _mint(to, tokenId);
        setTokenURI(tokenId);
        return true;
    }
